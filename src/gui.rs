...
impl EnigmaApp {
    ...
    fn render_header(&mut self, ui: &mut egui::Ui) {
        ui.vertical_centered(|ui| {
            ui.add_space(10.0);
            ui.heading(
                egui::RichText::new("🔐 Enigma-Simulator")
                    .size(24.0)
                    .color(egui::Color32::from_rgb(70, 130, 180)),
            );
            ui.add_space(5.0);
            ui.label(
                egui::RichText::new("Historische Verschlüsselungsmaschine")
                    .italics()
        ...
        ui.group(|ui| {
            ...
            ui.horizontal(|ui| {
                ...
                egui::ComboBox::from_id_source("preset_selector")
                    ...
                    .show_ui(ui, |ui| {
                        ui.selectable_value(
                            &mut self.selected_rotor_preset,
                            "Standard".to_string(),
                            "Standard",
                        );
                        ui.selectable_value(
                            &mut self.selected_rotor_preset,
                            "Kriegsmarine".to_string(),
                            "Kriegsmarine",
                        );
                        ui.selectable_value(
                            &mut self.selected_rotor_preset,
    ...
    fn initialize_machine(&mut self) {
        match self.create_machine_from_config() {
            ...
            Err(e) => {
                self.add_log_entry(
                    Level::Error,
                    &format!("Fehler bei Maschineninitialisierung: {}", e),
                );
            }
        }
    }
    ...
    fn process_text(&mut self) {
        ...
        self.add_log_entry(
            Level::Info,
            &format!("Verarbeitung abgeschlossen: '{}'", self.output_text),
        );
    }
    ...
    fn render_config_panel(&mut self, ui: &mut egui::Ui) {
        egui::ScrollArea::vertical()
            ...
            .show(ui, |ui| {
                ui.heading(
                    egui::RichText::new("🔧 Enigma-Konfiguration")
                        .size(18.0)
                        .color(egui::Color32::from_rgb(70, 130, 180)),
                );
                    ...
                    ui.horizontal(|ui| {
                        for i in 0..3 {
                            ui.vertical(|ui| {
                                ...
                                ui.label(
                                    egui::RichText::new(format!("Rotor {}", i + 1))
                    ...
                    ui.horizontal(|ui| {
                        for i in 0..3 {
                            ui.vertical(|ui| {
                                ...
                                ui.label(
                                    egui::RichText::new(format!("Position {}", i + 1))
                                        .color(rotor_colors[i])
                                        .size(12.0),
                                );
                                let pos_edit =
                                    egui::TextEdit::singleline(&mut self.rotor_positions[i])
                                        .char_limit(1)
                                        .desired_width(60.0);
                                ui.add(pos_edit);
                            });
                    ...
                    ui.horizontal(|ui| {
                        for i in 0..3 {
                            ui.vertical(|ui| {
                                ...
                                ui.label(
                                    egui::RichText::new(format!("Ring {}", i + 1))
                                        .color(rotor_colors[i])
                                        .size(12.0),
                                );
                                let ring_edit =
                                    egui::TextEdit::singleline(&mut self.ring_settings[i])
                                        .char_limit(1)
                                        .desired_width(60.0);
                                ui.add(ring_edit);
                            });
                ...
                ui.group(|ui| {
                    ...
                    ui.label(
                        egui::RichText::new(
                            "Format: AB CD EF (Buchstabenpaare durch Leerzeichen getrennt)",
                        )
                        .italics()
                        .color(egui::Color32::GRAY),
                    );
                ...
                ui.horizontal_centered(|ui| {
                    if ui
                        .add(
                            egui::Button::new(egui::RichText::new("🎲 Alles zufällig").size(16.0))
                        ...
                        .clicked()
                    {
                        ...
                        self.add_log_entry(
                            Level::Info,
                            "Komplette zufällige Konfiguration generiert!",
                        );
                    }
                    ...
                    if ui
                        .add(
                            egui::Button::new(
                                egui::RichText::new("✅ Konfiguration anwenden").size(16.0),
                            )
    ...
    fn render_text_panel(&mut self, ui: &mut egui::Ui) {
        ui.heading(
            egui::RichText::new("📝 Text-Verarbeitung")
                .size(18.0)
                .color(egui::Color32::from_rgb(70, 130, 180)),
        );
        ...
        ui.group(|ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(
                        egui::Button::new(
                            egui::RichText::new("🔒 Verschlüsseln").color(encrypt_color),
                        )
                        .fill(if encrypt_selected {
                            egui::Color32::from_rgba_premultiplied(0, 128, 0, 50)
                        } else {
                ...
                if ui
                    .add(
                        egui::Button::new(
                            egui::RichText::new("🔓 Entschlüsseln").color(decrypt_color),
                        )
                        .fill(if decrypt_selected {
                            egui::Color32::from_rgba_premultiplied(220, 20, 60, 50)
                        } else {
                            egui::Color32::TRANSPARENT
                        }),
                    )
        ...
        ui.group(|ui| {
            ...
            ui.horizontal(|ui| {
                ...
                ui.label(
                    egui::RichText::new(format!("{}", self.input_text.len()))
                        .color(egui::Color32::GRAY),
                );
            ...
            if ui
                .add(
                    egui::Button::new(egui::RichText::new(button_text).size(16.0))
                        .fill(button_color)
                        .min_size(egui::Vec2::new(150.0, 40.0)),
                )
                .clicked()
            {
                self.process_text();
        ...
        ui.group(|ui| {
            ...
            ui.horizontal(|ui| {
                ui.label(egui::RichText::new("Zeichen: ").color(egui::Color32::GRAY));
                ui.label(
                    egui::RichText::new(format!("{}", self.output_text.len()))
                        .color(egui::Color32::GRAY),
                );
                ...
                ui.horizontal(|ui| {
                    for i in 0..3 {
                        ...
                        ui.vertical(|ui| {
                            ...
                            ui.label(
                                egui::RichText::new(format!("Pos: {}", positions[i]))
                                    .color(rotor_colors[i])
                                    .size(14.0),
                            );
                            ui.label(
                                egui::RichText::new(format!("Ring: {}", ring_settings[i]))
                                    .color(egui::Color32::GRAY)
                                    .size(12.0),
                            );
                        });
    ...
    fn render_log_panel(&mut self, ui: &mut egui::Ui) {
        ui.heading(
            egui::RichText::new("📊 Verarbeitungs-Log")
                .size(18.0)
                .color(egui::Color32::from_rgb(70, 130, 180)),
        );
            ...
            .show(ui, |ui| {
                ...
                for entry in &filtered_entries {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        ui.label(
                            egui::RichText::new(&format!("{}: {}", entry.level, entry.message))
                                .color(color),
                        );
                    });
                }
                ...
                if entry_count == 0 && !self.log_entries.is_empty() {
                    ui.centered_and_justified(|ui| {
                        ui.label(
                            egui::RichText::new("🔍 Keine Einträge gefunden")
                                .color(egui::Color32::GRAY),
                        );
                    });
                }
...
impl eframe::App for EnigmaApp {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        if self.show_help {
            egui::Window::new("📖 Hilfe")
                ...
                .show(ctx, |ui| {
                    ...
                    ui.separator();
                    ui.label(
                        "1. Wählen Sie ein Konfigurations-Preset oder konfigurieren Sie manuell",
                    );
        ...
        egui::TopBottomPanel::bottom("status_bar").show(ctx, |ui| {
            ui.horizontal(|ui| {
                ui.label(
                    egui::RichText::new("🔐 Enigma-Simulator v1.0").color(egui::Color32::GRAY),
                );
